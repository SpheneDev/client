...
public sealed class CacheMonitor : DisposableMediatorSubscriberBase
{
    ...
    public CacheMonitor(ILogger<CacheMonitor> logger, IpcManager ipcManager, SpheneConfigService configService,
        FileCacheManager fileDbManager, SpheneMediator mediator, PerformanceCollectorService performanceCollector, DalamudUtilService dalamudUtil,
