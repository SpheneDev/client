...
public sealed class SpheneMediator : IHostedService
{
    ...
    public SpheneMediator(ILogger<SpheneMediator> logger, PerformanceCollectorService performanceCollector, SpheneConfigService SpheneConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting SpheneMediator");
        ...
        _logger.LogInformation("Started SpheneMediator");
