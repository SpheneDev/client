...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
        ...
        CharaDataCharacterHandler charaDataCharacterHandler, PairManager pairManager) : base(logger, spheneMediator)
    {
        ...
        spheneMediator.Subscribe<DisconnectedMessage>(this, (msg) =>
        {
            _ownCharaData.Clear();
            _metaInfoCache.Clear();
            _sharedWithYouData.Clear();
    ...
    public Task<(SpheneCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
