...
namespace Sphene.Services.CharaData.Models;

public record SpheneCharaFileData
{
    ...
    public SpheneCharaFileData() { }
    public SpheneCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static SpheneCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<SpheneCharaFileData>(Encoding.UTF8.GetString(data))!;
    }
