...
internal sealed class DalamudLogger : ILogger
{
    ...
    public DalamudLogger(string name, SpheneConfigService SpheneConfigService, IPluginLog pluginLog, bool hasModifiedGameFiles)
    {
        _name = name;
    ...
    {
        return (int)_SpheneConfigService.Current.LogLevel <= (int)logLevel;
    }
